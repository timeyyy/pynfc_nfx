...
static PyObject *
_cffi_layout_struct_passwd(PyObject *self, PyObject *noarg)
{
...
static PyMethodDef _cffi_methods[] = {
  {"getpwuid", _cffi_f_getpwuid, METH_O, NULL},
  {"_cffi_layout_struct_passwd", _cffi_layout_struct_passwd, METH_NOARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x77ffdf72xc3efe065(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x77ffdf72xc3efe065(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x77ffdf72xc3efe065", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
