...
PyMODINIT_FUNC
PyInit__cffi__xdb030e4ex88d30087(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xdb030e4ex88d30087(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xdb030e4ex88d30087", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
