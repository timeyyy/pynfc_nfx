...
PyMODINIT_FUNC
PyInit__cffi__xd0204f13xaa18a49a(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xd0204f13xaa18a49a(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xd0204f13xaa18a49a", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
